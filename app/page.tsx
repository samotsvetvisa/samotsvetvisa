      ...
      <main>
        ...
        <section className="principle-band">
          <div className="section-shell principle-grid">
            ...
            <p>
              Для Global Talent в digital technology нужны три рекомендательных письма и до десяти документов-доказательств.
              Эндорсмент обычно занимает 5–8 недель, а визовое решение из-за пределов Великобритании — еще около 3 недель.
            </p>
          </div>
        </section>

      ...
      <main>
        ...
        <section className="section-shell section-block process-section" id="process">
          ...
          <ol className="process-list">
            ...
            <li><span>07</span><div><h3>Финальная проверка, формы и подача</h3><p>Команда Samotsvet проверяет комплект, готовит формы, подключает профильных партнеров там, где это требуется, и сопровождает подачу до решения.</p></div></li>
          </ol>
        </section>
        ...
        <section className="section-shell development-product">
          ...
          <div><p>Для маршрутов, где доказательств пока недостаточно, мы проводим аудит доказательной базы и составляем отдельный план развития: проекты, публикации, выступления, показатели, рекомендации и контрольные точки.</p><Link className="text-link" href="/profile-development/">Как устроена программа <span aria-hidden="true">↗</span></Link></div>
        </section>

  ...
  ru: [
    {
      ...
      routes: [
        ...
        },
        {
          ...
          forWhom: "Фаундеры с новой, жизнеспособной и масштабируемой бизнес-моделью, которую планируют реализовывать в Великобритании.",
      ...
      routes: [
        {
          ...
          forWhom: "Фаундеры и ключевые участники инновационных проектов, которым нужна французская экосистема для реализации плана.",

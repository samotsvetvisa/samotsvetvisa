...
export function AssessmentForm({ initialCountry = "", locale = "ru" }: { initialCountry?: string; locale?: Locale }) {
  ...
  async function submitDetail(event: FormEvent<HTMLFormElement>) {
    ...
    const crmTiming = {
      ...
      planned: "6-12 months",
      long: "12+ months",
    }[answers.timing as "urgent" | "medium" | "planned" | "long"];

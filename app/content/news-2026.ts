...
export const news2026: Article[] = [
  ...
  },
  {
    ...
    sections: [
      { title: "Что открылось 1 июля", paragraphs: ["Официальная формулировка говорит о дополнительных дизайнерских ролях, которые раньше не были охвачены. Поэтому неверно считать, что архитектура и мода впервые появились в Global Talent: для них существовали отдельные механизмы и раньше."] },
      { title: "Портфолио еще не доказывает признание", paragraphs: ["Портфолио показывает качество работы. Для иммиграционного кейса нужно дополнительно показать личную роль, независимую оценку и значение результата за пределами собственной команды."], points: ["Кто оценил работу независимо от работодателя", "Что именно сделал заявитель в командном проекте", "Какие измеримые изменения произошли после его работы"] },
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Почему старого подтверждения может не хватить", paragraphs: ["Документ, которым заявитель подтвердил B1 на входе, не обязательно подтверждает B2 на этапе ILR. Важно заранее установить, какой уровень указан в дипломе, тесте или ином допустимом подтверждении."] },
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Почему нужен запас", paragraphs: ["Если доход поступает в другой валюте, минимальное соответствие в день расчета не дает устойчивости. Мы закладываем запас на курсовые колебания и проверяем, подтверждается ли заявленная сумма договорами, поступлениями и банковскими документами."] },
    ],
  },
  {
    slug: "spain-dnv-real-work",
    tag: "Испания · Digital Nomad Visa",
    title: "Договор под визу не заменяет реальную удаленную работу",
  ...
  },
  {
    ...
    title: "Статистика USCIS: что она говорит — и чего не говорит о Вашем деле",
  ...
  },
  {
    ...
    tag: "США · EB-1A",
    title: "Срок рассмотрения EB-1A — не обещанная дата решения",
  ...
  },
  {
    ...
    sections: [
      ...
      { title: "Чего пока нет", paragraphs: ["Запись в Unified Agenda не равна опубликованному тексту предлагаемого правила. Пока нет финальной редакции и даты вступления в силу, невозможно честно сказать, какие доказательства станут сильнее или слабее."] },
  ...
  },
  {
    ...
    sections: [
      { title: "B2 — это не бытовая разговорная речь", paragraphs: ["Уровень предполагает понимание сложных текстов и способность ясно развивать аргументацию. Свободное общение в магазине или с соседями не подтверждает письменную часть B2."] },

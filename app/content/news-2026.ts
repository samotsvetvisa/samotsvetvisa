...
export const news2026: Article[] = [
  {
    ...
    tag: "Великобритания · Immigration Rules",
    title: "HC 584: что сентябрьские изменения значат для Global Talent и Innovator Founder",
    description: "Пакет правил от 3 сентября 2026 года и его практическое значение для двух независимых талант-маршрутов.",
    reading: "4 минуты",
    published: "2026-09-03",
    author: "Редакция Samotsvet",
    lead: "3 сентября 2026 года Home Office опубликовал пакет HC 584. Большинство его положений вступит в силу 8 октября, но отдельных изменений требований Global Talent и Innovator Founder в документе нет.",
    relatedCountry: "uk",
    sources: [
      ...
      { label: "GOV.UK - пояснительная записка к HC 584", href: "https://www.gov.uk/government/publications/statement-of-changes-to-the-immigration-rules-hc-584-3-september-2026/explanatory-memorandum-to-the-statement-of-changes-in-immigration-rules-hc-584-3-september-2026-accessible" },
    ...
    sections: [
      { title: "Что входит в пакет", paragraphs: ["HC 584 меняет отдельные положения Skilled Worker, Student, EU Settlement Scheme, Visitor и ряда других маршрутов. Основная группа изменений применяется с 8 октября 2026 года; для некоторых положений установлены даты 29 октября, 30 ноября и 9 декабря.", "Заявления, поданные до соответствующей даты вступления в силу, в предусмотренных документом случаях рассматриваются по прежней редакции правил. Поэтому для затронутых маршрутов важна не только тема изменения, но и точная дата подачи."] },
      { title: "Что с Global Talent и Innovator Founder", paragraphs: ["В перечне изменяемых приложений нет Appendix Global Talent и Appendix Innovator Founder. Сентябрьский пакет не вводит для этих маршрутов новые критерии, пороги дохода или требования к эндорсменту.", "Это не означает, что британская иммиграционная система в целом остается без изменений. Корректный вывод ограничен самим документом: HC 584 не ухудшил условия Global Talent и Innovator Founder."] },
      { title: "Взгляд Samotsvet", paragraphs: ["На фоне крупных пакетов правил легко принять общее ужесточение за изменение любого британского маршрута. Мы сначала проверяем, какое приложение изменено и с какой даты, и только затем пересчитываем стратегию.", "Для кандидатов Global Talent и Innovator Founder оснований перестраивать кейс из-за HC 584 нет. Продолжаем работать по действующим критериям и отдельно следим за будущими изменениями, которые прямо затронут соответствующее приложение."] },
    ],
  },
  {
    slug: "us-diversity-visa-pause-august-2026",
    tag: "США · Diversity Visa",
    title: "Diversity Visa снова приостановлена после отмены прежней паузы",
    description: "Почему отмена декабрьского ограничения не привела к возобновлению выдачи Diversity Visa.",
    reading: "4 минуты",
    published: "2026-08-31",
    author: "Редакция Samotsvet",
    lead: "28 августа прежняя приостановка Diversity Visa перестала действовать по решению суда. Сразу после этого Госдепартамент ввел новую паузу на выдачу виз этой категории для дополнительной проверки процедур безопасности.",
    relatedCountry: "usa",
    sources: [
      { label: "Department of State - обновленные правила выдачи Diversity Visa", href: "https://travel.state.gov/content/travel/en/News/visas-news/diversity-visa-issuance-updated-guidance.html" },
    ],
    sections: [
      { title: "Что действует сейчас", paragraphs: ["Госдепартамент продолжает принимать заявления и назначать интервью. Однако во время новой паузы Diversity Visa не выдаются. В официальном разъяснении исключения не предусмотрены.", "Действующие визы этим решением не аннулированы. Ограничение относится к выдаче новых Diversity Visa, а не ко всем иммиграционным категориям США."] },
      { title: "Почему это отдельная история", paragraphs: ["Отмена более широкой январской приостановки для граждан 75 стран и правила Diversity Visa основаны на разных документах. Положительная новость по одному ограничению не отменяет другое.", "EB-1A и EB-2 NIW не относятся к Diversity Visa. Для них нужно отдельно проверять статус петиции, доступность визового номера и работу конкретного консульского поста."] },
      { title: "Взгляд Samotsvet", paragraphs: ["Эта новость показывает, почему нельзя строить план только по заголовку об отмене ограничений. Мы разделяем категорию, этап и государственный орган: судебное решение может убрать один барьер, но не запустить выдачу по другой программе.", "Заявителям Diversity Visa имеет смысл сохранять назначенные интервью и комплект документов, но планировать сроки только после нового официального обновления. Кандидатам EB-1A и NIW не нужно переносить на свой кейс ограничения, установленные именно для DV."] },
    ],
  },
  {
    slug: "us-immigrant-visa-pause-lifted-august-2026",
    tag: "США · Иммиграционные визы",
    title: "Госдепартамент снял общую паузу на иммиграционные визы для россиян",
    description: "Официальное обновление от 28 августа и следующие проверки для консульских кейсов EB-1A и NIW.",
    reading: "4 минуты",
    published: "2026-08-28",
    author: "Редакция Samotsvet",
    lead: "Госдепартамент подтвердил, что с 21 августа 2026 года прежняя приостановка выдачи иммиграционных виз гражданам 75 стран, включая Россию, больше не действует.",
    relatedCountry: "usa",
    sources: [
      { label: "Department of State - обновление по выдаче иммиграционных виз", href: "https://travel.state.gov/content/travel/en/News/visas-news/immigrant-visa-processing-updates-for-nationalities-at-high-risk-of-public-benefits-usage.html" },
      { label: "CLINIC v. Rubio - материалы дела", href: "https://www.nilc.org/litigation/clinic-v-rubio/" },
      { label: "Department of State - место интервью по иммиграционной визе", href: "https://travel.state.gov/content/travel/en/News/visas-news/adjudicating-iv-applicants-in-their-country-of-residence.html" },
    ],
    sections: [
      { title: "Что изменилось 28 августа", paragraphs: ["На официальной странице Госдепартамента теперь прямо указано: январская пауза больше не действует в соответствии с решением суда по делу CLINIC v. Rubio. Заявители могут подавать документы, проходить интервью и получать решение без этого общего запрета по гражданству.", "Обновление не отменяет обычную проверку допустимости, public charge, полноты документов и других требований конкретной иммиграционной категории."] },
      { title: "Что это значит для EB-1A и NIW", paragraphs: ["Для заявителей, которые проходят EB-1A или EB-2 NIW через консульское оформление, снят отдельный барьер на финальной стадии выдачи визы. Одобрение I-140, доступность визового номера и консульское решение при этом остаются самостоятельными этапами.", "Перед планированием переезда нужно подтвердить место интервью, доступные даты и фактическую работу выбранного консульского поста. Общая публикация Госдепартамента не устанавливает одинаковые сроки для всех посольств и дел."] },
      { title: "Взгляд Samotsvet", paragraphs: ["Это существенное улучшение для российских кандидатов, но не повод считать весь процесс восстановленным автоматически. Мы бы не меняли категорию и не пересобирали доказательства только из-за этой новости: сначала проверяем, на каком этапе находится конкретное дело и какое препятствие действительно осталось.", "Для новых кейсов снова можно считать консульское оформление рабочим сценарием, сохраняя запас по срокам и альтернативу на случай операционных задержек. Для уже одобренных петиций приоритетом становится проверка NVC, консульского поста и финансовых документов."] },
    ],
  },
  {
    slug: "us-immigrant-visa-issuance-pause-russia",
    tag: "США · Иммиграционные визы",
    title: "Суд отменил приостановку иммиграционных виз: что это значит для граждан России",
    description: "Хронология с 21 января по 26 августа 2026 года: решение окружного суда, спор об исполнении и последствия для EB-1A и NIW.",
    reading: "6 минут",

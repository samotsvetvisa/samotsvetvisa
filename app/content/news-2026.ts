...
export const news2026: Article[] = [
  {
    ...
    title: "США приостановили выдачу иммиграционных виз гражданам России: что это меняет для EB-1A и NIW",
    description: "Как соотносятся приостановка выдачи виз, петиции USCIS, интервью и доступность визовых номеров в 2026 году.",
    reading: "5 минут",
    published: "2026-08-27",
    author: "Никита Самоцветов",
    lead: "С 21 января 2026 года Госдепартамент США приостановил выдачу иммиграционных виз гражданам России. Это существенное ограничение для консульского этапа EB-1A и EB-2 NIW, но не запрет на подачу всех петиций и не остановка всех американских виз.",
    relatedCountry: "usa",
    sources: [
    ...
    sections: [
      { title: "Что именно приостановлено", paragraphs: ["Мера относится к выдаче иммиграционных виз гражданам перечисленных стран, включая Россию. Госдепартамент прямо указывает, что заявления и интервью могут продолжаться, но виза не выдается, пока действует приостановка.", "Исключение предусмотрено для двойных граждан, которые подают заявление с действительным паспортом страны, не включенной в список. Уже выданные визы этим решением не аннулированы."] },
      { title: "Какие маршруты затронуты", paragraphs: ["EB-1A и EB-2 NIW приводят к иммиграционной визе при консульской процедуре, поэтому пауза влияет на финальную выдачу такой визы гражданину России. Петиция I-140 и консульский этап — разные процедуры: одобрение петиции само по себе не снимает ограничение Госдепартамента.", "O-1 и E-2 являются неиммиграционными категориями и этой конкретной приостановкой не охвачены. Это не означает автоматическую доступность: по ним действуют собственные требования и консульские процедуры."] },
      { title: "Почему current в Visa Bulletin не решает проблему", paragraphs: ["В сентябре 2026 года EB-1 и EB-2 указаны как current для All Chargeability Areas Except Those Listed. Это означает доступность визового номера для соответствующей категории и страны учета, но не отменяет отдельную приостановку выдачи виз по гражданству."] },
      { title: "Что проверить в стратегии", paragraphs: ["Нужно разделить четыре вопроса: одобрение петиции USCIS, доступность визового номера, возможность выдачи визы конкретному гражданину и место интервью. Adjustment of status внутри США анализируется отдельно от консульской выдачи. Вывод зависит от гражданства, второго гражданства, страны проживания и текущего статуса."], points: ["Гражданство и возможное второе гражданство", "Консульская процедура или adjustment of status", "Категория: иммиграционная или неиммиграционная", "Страна проживания и назначаемый консульский пост"] },
    ],
  },
  {

      ...
      <main>
        <section className="inner-hero section-shell assessment-hero">
          <div>
            ...
            <h1>Восемь вопросов — около пяти минут</h1>
          </div>
          <p>
            Мы изучим анкету и ответим в течение двух рабочих дней. Вы получите предварительное сравнение маршрутов, оценку исходного профиля и возможный формат работы.
          </p>
        </section>

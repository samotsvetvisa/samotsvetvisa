        ...
        <article className="legal-page section-shell privacy-page">
          ...
          <section>
            ...
            <ul>
              ...
              <li><strong>Enquiry data:</strong> work and experience summary, selected country or goal, intended relocation timing and the programme topic where the user arrives from a specific route page.</li>
              <li><strong>Attribution data:</strong> landing page, page leading to the form, external referring page, button location and permitted UTM source, medium, campaign, content and term values.</li>
          ...
          <section>
            ...
            <div className="legal-table-wrap">
              <table className="legal-table">
                ...
                <tbody>
                  <tr><td>Replying to an enquiry and arranging a free consultation</td><td>Name, contact details and short-form content</td><td>Steps taken at the data subject&apos;s request before entering into a contract; consent where required</td></tr>
                  <tr><td>Preparing a proposal and negotiating terms</td><td>Contact details, selected country or goal, experience summary and timing</td><td>Pre-contractual steps and subsequent performance of a contract</td></tr>
                  <tr><td>Understanding enquiry sources and improving the site</td><td>UTM values, entry and source pages, external referrer and button location</td><td>Legitimate interest in measuring Samotsvet&apos;s own channels with limited data</td></tr>
          ...
          <section>
            ...
            <p>Data normally comes directly from the person submitting the enquiry. The initial form asks for a name, contact method, short work and experience summary, country or goal and intended relocation timing. After consent is confirmed, the request is sent directly to the CRM for specialist review before the free consultation is arranged.</p>
          </section>
          ...
          <section>
            ...
            <p>The Samotsvet site does not set cookies, advertising pixels or third-party analytics. During an open tab, sessionStorage holds only technical enquiry context: permitted UTM values, entry and source pages, the external referrer and button location. Form fields are not written to this storage, and the browser removes the context when the tab is closed. The hosting provider may process request data and logs required for page delivery, security and fault diagnosis.</p>
          </section>
          ...
          <section>
            <h2>12. Enquiry review</h2>
            <p>The form collects information for initial contact and sends it to the CRM. It does not calculate approval prospects or select a programme automatically.</p>
            <p>A specialist provides a preliminary view during or after the consultation. That view is not legal advice, a guarantee of approval or a decision by an immigration authority.</p>
          </section>

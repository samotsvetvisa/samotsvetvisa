      ...
      <main>
        ...
        <section className="section-shell founder-profile" id="nikita">
          ...
          <div className="founder-copy">
            ...
            <p>Since 2021, we have reviewed <strong>more than 10,000 professional profiles</strong>. We led some projects in full and worked with agencies on route assessment or individual preparation stages in others. The United Kingdom remains one of our core destinations.</p>
        ...
        <section className="section-shell values-grid facts-grid">
          ...
          <article><span>02</span><h2>14 countries in comparative reviews</h2><p>Alongside the site&apos;s four core destinations, we assessed routes in Australia, Bulgaria, Portugal, Argentina, China, Japan, Canada, Switzerland, Luxembourg and Germany.</p></article>
          <article><span>03</span><h2>Work with agencies</h2><p>We worked with agencies as a partner on profile reviews and individual parts of client projects.</p></article>
        ...
        <section className="section-shell closing-cta">
          ...
          <div><p>A short enquiry gives us enough information for a useful first conversation.</p><Link className="button button-gold" href="/en/assessment/">Get a preliminary assessment</Link></div>
        </section>
      </main>

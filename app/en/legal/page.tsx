...
export default function EnglishLegalPage() {
  return (
    <><SiteHeader locale="en" /><main><article className="legal-page section-shell">
      ...
      <section><h2>2. Full-cycle agency</h2><p>Samotsvet manages immigration and visa projects from initial review to filing: route comparison, strategy, profile development, evidence preparation, referee co-ordination and overall project management.</p></section>
      ...
      <section><h2>7. Outcome and currency of information</h2><p>The competent public authority makes the final decision. Samotsvet is responsible for the quality of the strategy, preparation and project management. Destination pages record the date on which official sources were checked; rules may change after that date.</p></section>

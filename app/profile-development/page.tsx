...
export const metadata: Metadata = pageMetadata({
  ...
  description: "Проверка доказательств и план усиления профиля на 6–12 месяцев для Global Talent, EB-1A, EB-2 NIW, O-1 и других сложных маршрутов.",
  path: "/profile-development",
});

const stages = [
  ["Проверка доказательств", "Проверяем достижения, документы и независимые источники. Для каждого требования фиксируем сильные подтверждения, слабые места и отсутствующие факты."],
      ...
      <main>
        ...
        <section className="section-shell development-page">
          <div className="development-intro">
            ...
            <p>Вы получаете проверку текущих доказательств, выбранный рабочий маршрут, план усиления на 6–12 месяцев и контрольные точки. Продолжительность зависит от исходного профиля и программы.</p>
          </div>
        ...
        <section className="section-shell closing-cta">
          <div><p className="eyebrow eyebrow-light">Первичная консультация</p><h2>Обсудим исходный профиль и цель</h2></div>
          <div><p>Если нужна программа развития, после разговора зафиксируем объем работы, ориентир по срокам и стоимость.</p><ConsultationLink className="button button-gold" location="profile_development_final" /></div>
        </section>
      </main>
      <SiteFooter />
    </>

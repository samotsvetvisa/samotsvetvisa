...
export const metadata: Metadata = pageMetadata({
  title: "О нас",
  description: "Команда Samotsvet: более 10 000 разобранных профилей, 800+ успешно завершенных кейсов и единая методология подготовки.",
  path: "/about",
});
      ...
      <main>
        ...
        <section className="section-shell founder-profile" id="nikita">
          ...
          <div className="founder-copy">
            ...
            <p>Совокупный опыт команды с 2021 года включает <strong>более 10 000 разобранных профессиональных профилей</strong> и более 800 успешно завершенных кейсов. Часть проектов команда вела целиком, к части подключалась как партнер других агентств. Более 200 дел были связаны с Великобританией.</p>
            <p>До запуска Samotsvet Никита работал в иммиграционном агентстве с кейсами специалистов, предпринимателей и семей. Этот опыт стал основой методологии команды: мы разбираем исходные данные, определяем нужные доказательства, проверяем источники и сверяем факты между документами.</p>
        ...
        <section className="section-shell values-grid facts-grid">
          ...
          <article><span>02</span><h2>800+ завершенных кейсов в опыте команды</h2><p>Часть проектов мы вели целиком, к части подключались как партнер других агентств. Более 200 дел были связаны с Великобританией.</p></article>

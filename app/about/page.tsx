    ...
    <>
      ...
      <main>
        ...
        <section className="section-shell values-grid facts-grid">
          ...
          <article><span>03</span><h2>Работа с агентствами</h2><p>Другие агентства приглашали нас как партнеров для разбора профилей и подготовки отдельных частей проектов.</p></article>

...
export const metadata: Metadata = pageMetadata({
  title: "О нас",
  description: "Никита Самоцветов, основатель Samotsvet: более 10 000 разобранных профилей, 800+ успешно завершенных кейсов и степень LLM University of Leeds.",
  path: "/about",
});
      ...
      <main>
        ...
        <section className="section-shell founder-profile" id="nikita">
          ...
          <div className="founder-copy">
            ...
            <p>С 2021 года мы проанализировали <strong>более 10 000 профессиональных профилей</strong> и успешно завершили более 800 клиентских кейсов, включая более 200 по Великобритании.</p>
            ...
            <p>В фокусе — Global Talent и Innovator Founder в Великобритании, O-1, EB-1A, EB-2 NIW и E-2 в США, Digital Nomad Visa (DNV) в Испании, French Tech Visa и другие маршруты Passeport Talent во Франции.</p>
        ...
        <section className="section-shell values-grid facts-grid">
          <article><span>01</span><h2>10 000+ разобранных профилей</h2><p>Специалисты, предприниматели, их семьи и компании из Великобритании, США, Испании, Франции, Канады и Австралии.</p></article>
          <article><span>02</span><h2>800+ успешных кейсов</h2><p>Завершенные клиентские проекты по визовым и иммиграционным маршрутам, из них более 200 — по Великобритании.</p></article>

...
export const SERVICE_PRICES = [
  ...
  { code: "US", countryRu: "США", countryEn: "United States", price: "от €8 000", priceEn: "from €8,000", timelineRu: "от 1 месяца", timelineEn: "from 1 month", noteRu: "Рассмотрение ведомством зависит от маршрута. Подробные сроки указаны на странице США.", noteEn: "Government processing depends on the route. The US page sets out route-specific timing." },
  ...
  { code: "FR", countryRu: "Франция", countryEn: "France", price: "от €6 000", priceEn: "from €6,000", timelineRu: "от 2 месяцев", timelineEn: "from 2 months", noteRu: "Объем зависит от основания, стадии проекта и необходимости подтверждать инновационность, финансирование и роль основателя. Внешние заключения и государственные сборы рассчитываются отдельно.", noteEn: "Scope depends on the route, project stage and the evidence needed for innovation, funding and the founder's role. External opinions and government fees are quoted separately." },
] as const;
